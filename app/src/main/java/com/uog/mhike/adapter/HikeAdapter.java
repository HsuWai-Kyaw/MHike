...
public class HikeAdapter extends RecyclerView.Adapter<HikeAdapter.ViewHolder>{
    ...
    public interface ClickListener{
        public void onButtonClick(int position, View v, long id); // position-clicked record position, view-button control, id-button id for check
    }
    ...
    @NonNull
    @Override
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) { //Design connect
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.hike_list_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) { //Data into Design
    ...
    @Override
    public int getItemCount() { return hikeList.size(); }
